...
export default function AdminUsersPage() {
    ...
    return (
        <div className="container page toppings-admin">
                ...
                <div className="list">
                    {filtered.map(u => (
                        <div key={u._id} className="card">
                            <div>
                                <div className="title">Email: {u.email}</div>
                                <div style={{ opacity: .85, fontSize: '.95em' }}>Username: {u.displayName || "(none)"}</div>

                                <div style={{ display: "flex", gap: 8, marginTop: 6, flexWrap: "wrap" }}>
                                    <span className="pill">{u.role || "?"}</span>
                                    <span className="pill">{u.isActive === false ? "DISABLED" : "ACTIVE"}</span>
                                </div>
                            </div>
